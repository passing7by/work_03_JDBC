...
//		printAllBooks(dao.discntPrice("자앤 출판사", 50));
		...
		//7.
		System.out.println("\n------------------ listBooksAndAuthors ------------------");
		printAllBAA(dao.listBooksAndAuthors());
		
		//8.
		System.out.println("\n------------------ findBookAuthorOf ------------------");
		printAllBAA(dao.findBookAuthorOf("이"));
		printAllBAA(dao.findBookAuthorOfKim());
		
		//9.
		System.out.println("\n------------------ listBooksByAuthors ------------------");
		printAllBAA(dao.listBooksByAuthors());
		
		//10.
		System.out.println("\n------------------ listTitleAndPublisher ------------------");
		printAllBAA(dao.listTitleAndPublisher());
	...
	private static void printAllBAA(List<String> list) {
		for (String s : list) {
